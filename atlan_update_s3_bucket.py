...
def update_s3_bucket(client,atlan_s3_bucket_asset_name,s3_bucket_asset_qualified_name,atlan_owner_user,s3_bucket_aws_region,s3_bucket_asset_object_count):
